...
const ENGLISH_PREFECTURE_TO_REGION = {
  // 本州
...
/**
 * Map a prefecture name to its shipping region key. Accepts both the Japanese
 * name ("東京都") and the English/romaji form BigCommerce stores on orders
 * ("Tokyo", case-insensitive).
